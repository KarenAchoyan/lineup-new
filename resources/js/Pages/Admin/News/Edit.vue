            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                        <h2 class="text-xl font-semibold text-gray-900">Edit News</h2>
                    </div>
                    ...
                    <form @submit.prevent="handleSubmit" class="p-6 space-y-6">
                        ...
                        <!-- Current Image -->
                        <div v-if="news.avatar">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Current Image</label>
                            <img :src="`/storage/${news.avatar}`" class="w-32 h-32 object-cover rounded-lg" />
                        </div>

                        <!-- Image -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">{{ news.avatar ? 'Replace Image' : 'Image' }}</label>
...
const editorContent = ref({
    ...
    content_hy: props.news.content_hy || '',
    content_ge: props.news.content_ge || '',
...
const form = useForm({
    ...
    title_hy: props.news.title_hy || '',
    title_ge: props.news.title_ge || '',
