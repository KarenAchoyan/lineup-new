            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                        <h2 class="text-xl font-semibold text-gray-900">Ստեղծել միջոցառում</h2>
                    </div>
                    ...
                    <form @submit.prevent="handleSubmit" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div v-if="form.errors.event_date" class="mt-1 text-sm text-red-600">{{ form.errors.event_date }}</div>
                        </div>
                        ...
                        <!-- Image -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Միջոցառման նկար</label>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t">
                            ...
                            <button type="submit" :disabled="form.processing" class="px-6 py-2 bg-[#F15A2B] text-white rounded-lg hover:bg-[#BF3206] disabled:opacity-50">
                                {{ form.processing ? 'Ստեղծվում է...' : 'Ստեղծել միջոցառում' }}
                            </button>
                        </div>
                    </form>
                </div>
