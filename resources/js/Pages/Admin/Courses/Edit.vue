                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div v-if="course.background_image" class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Current Background Image</label>
                                <img :src="`/storage/${course.background_image}`" alt="Current" class="w-32 h-32 object-cover rounded-lg" />
                            </div>

                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 mb-2">New Background Image (leave empty to keep current)</label>
                                <input
                                    type="file"
...
const form = useForm({
    name_en: props.course.name_en || '',
    name_hy: props.course.name_hy || '',
    name_ge: props.course.name_ge || '',
    name_ru: props.course.name_ru || '',
    slug: props.course.slug || '',
    price: props.course.price || 0,
    months: props.course.months || 12,
    background_image: null,
    description_en: props.course.description_en || '',
    description_hy: props.course.description_hy || '',
    description_ge: props.course.description_ge || '',
    description_ru: props.course.description_ru || '',
    branches: props.course.branches ? props.course.branches.map(b => b.id) : [],
