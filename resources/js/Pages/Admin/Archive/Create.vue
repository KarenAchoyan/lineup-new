<template>
    <AuthenticatedLayout>
        <Head title="Create Archive Item" />

        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Create Archive Item</h2>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div v-if="form.type === 'image' || form.type === 'news'" class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Image <span v-if="form.type === 'image'">*</span></label>
                                <input
                                    type="file"
...
const submit = () => {
    form.post(route('admin.archive.store'), {
        forceFormData: true,
    });
};
</script>
