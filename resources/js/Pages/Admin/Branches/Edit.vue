        ...
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Edit Branch</h2>
...
const form = useForm({
    name_en: props.branch.name_en || '',
    name_hy: props.branch.name_hy || '',
    name_ge: props.branch.name_ge || '',
    name_ru: props.branch.name_ru || '',
    order: props.branch.order || 0,
