            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-2">View and manage conversations with teachers</p>
                    </div>
                    <Link
                        :href="route('admin.messages.create')"
                        class="px-6 py-3 bg-[#F15A2B] text-white font-semibold rounded-lg hover:bg-[#BF3206] transition-colors shadow-md hover:shadow-lg flex items-center"
                    >
                ...
                <div v-if="messages.length === 0" class="bg-white rounded-lg shadow-sm p-12 text-center">
                    ...
                    <p class="text-gray-500 text-lg mb-4">No conversations yet.</p>
                    <Link
                        :href="route('admin.messages.create')"
                        class="inline-flex items-center px-4 py-2 bg-[#F15A2B] text-white rounded-lg hover:bg-[#BF3206]"
                    >
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex items-center gap-4 text-xs text-gray-500">
                                        <span class="flex items-center">
                                            ...
                                            {{ message.is_from_me ? 'To' : 'From' }}: {{ message.other_user_name }}
                                        </span>
                                        <span class="flex items-center">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                            {{ message.updated_at_human }}
                                        </span>
                                    </div>
                                </div>
